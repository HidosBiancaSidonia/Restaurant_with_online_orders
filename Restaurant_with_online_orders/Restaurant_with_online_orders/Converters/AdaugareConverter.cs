...
{
    class AdaugareConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            if (values[0] != null && values[1] != null && values[2] != null && values[3] != null &&
                ...
                values[11] != null && values[12] != null && values[13] != null )
            {
                List<string> alergeni = new List<string>();
                alergeni.Add(values[6].ToString());
                ...
                { 
                    ...
                    Categorie = values[1].ToString(),
                    Pr = values[2].ToString(),
                    CantitateP = values[3].ToString(),
                    CantitateT = values[4].ToString(),
                    Fotografie = values[5].ToString(),
                    Alergeni = alergeni
                };
            }
            else
        ...
        public object[] ConvertBack(object value, Type[] targetTypes, object parameter, CultureInfo culture)
        {
            ...
            object[] result = new object[7] { angajat.Denumire, angajat.Categorie, angajat.Pret, angajat.CantitatePortie, angajat.CantitateTotala, angajat.Fotografie, angajat.Alergeni };
            return result;
        }
    }
}
